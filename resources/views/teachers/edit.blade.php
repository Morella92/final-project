        ...
        <form class="row g-3" action="{{ route('teachers.update', $teacher) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <div class="dropdown @error('specializations') is-invalid @enderror">
                    <button class="message-style  btn btn-white dropdown-toggle text-white" type="button"
                        id="specializationsDropdown" required data-bs-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false">
            ...
            <div>
                ...
                <div class="form-floating mb-3">
                    <textarea class="message-style form-control @error('performance') is-invalid @enderror"
                        placeholder="Insert performance here" id="performance" name="performance" style="height: 200px">{{ old('performance') ?? $teacher->performance }}</textarea>
                    @error('performance')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            {{-- telefono --}}
            <div class="col-md-6">
                <label for="phone" class="form-label text-white fw-bold">Numero di telefono</label>
            ...
            {{-- IMG PROFILO --}}
            <div class="mt-4">
                <label for="cv" class="form-label fw-bold text-uppercase text-white">Carica o sostituisci l'immagine
                    di
                    profilo</label>
